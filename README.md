...
<div align="center">
  <img src="./public/logo.svg" alt="SandboxCurator — Garry&apos;s Mod — Playfield" width="64" height="64">
  <h1>SandboxCurator — Garry&apos;s Mod — Playfield</h1>
</div>

An independent project specification for Garry's Mod, covering local scenario manifests, addon conflict worksheets, map test checklists.
...
<img src="./public/screenshots/desktop-main.svg" alt="Garry&apos;s Mod — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="Garry&apos;s Mod — compact concept, not a screenshot" width="250">
<br>
...
- **Local scenario manifests** — planned module; not implemented.
- **Addon conflict worksheets** — planned module; not implemented.
- **Map test checklists** — planned module; not implemented.

The proposed workflow separates local scenario manifests from addon conflict worksheets, with map test checklists retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Local scenario manifests**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="SandboxCurator — Garry&apos;s Mod — Playfield — specification review workflow">
<br>
...
### Local scenario manifests

Define the input and expected outcome for module 1. Record the Garry's Mod version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Addon conflict worksheets

Define the input and expected outcome for module 2. Record the Garry's Mod version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Map test checklists

Define the input and expected outcome for module 3. Record the Garry's Mod version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.
...
| Planned output | Local scenario manifests |
